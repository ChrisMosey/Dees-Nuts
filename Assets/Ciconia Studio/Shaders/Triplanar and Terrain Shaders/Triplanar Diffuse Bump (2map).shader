...
Shader "Ciconia Studio/Effects/Triplanar/Diffuse Bump (2map)" {
    Properties {
        ...
        [Space(15)]_NormalSidesXZ ("Normal Sides (XZ)", 2D) = "bump" {}
        [Space(10)]_NormalIntensityX ("Normal Intensity X", Range(0.01, 2)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 GB = node_9302;
                float2 node_5066 = GB;
                float3 _N1 = UnpackNormal(tex2D(_NormalSidesXZ,TRANSFORM_TEX(node_5066, _NormalSidesXZ))); // X ForntBack
                ...
                float2 RG = node_8575;
                float2 node_1837 = RG;
                float3 _node_6848 = UnpackNormal(tex2D(_NormalSidesXZ,TRANSFORM_TEX(node_1837, _NormalSidesXZ))); // Z LeftRight
